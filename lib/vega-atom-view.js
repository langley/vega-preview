...
const constSpecForInvalidUse = {
  "$schema": "https://vega.github.io/schema/vega-lite/v2.0.json",
  "title": "INVALID vega-lite spec.",
  "description": "Plot to show for an invalid spec parse.",
  "data": {
    "values": [ ]
  },
  "encoding": {
  ...
  constructor(serializedState) {
    ...
    this.subscriptions = atom.workspace.getCenter().observeActivePaneItem(item => {
      ...
      try {
        ...
        // TODO: in or out!? renderVega(constSpecForInvalidUse, this.element);
      }
    });
  }
...
function renderVega(spec, element) {
  ...
  newChart.textContent = 'valid vega specs will render here';
